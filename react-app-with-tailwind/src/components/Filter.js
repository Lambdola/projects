  ...
  return (
    <div>
        <form onSubmit={handleSubmit} className='space-y-2 p-1 relative mt-2'>
            <input name="Year" value={filter.Year} onChange={handleFilterChange} type="text" autoComplete='off' placeholder="-Year-" className='peer/name border border-violet-950 h-9 w-full p-2 pt-3 focus:placeholder:invisible placeholder:p-2'/>
            <p className='peer-focus/name:visible invisible absolute left-2 -top-2 text-[0.7rem] bg-white px-2 font-bold text-center'>Year</p>
