        ...
        <div  className='fixed bg-white h-96 w-[21.5rem] top-28 ml-2 rounded-xl p-3 shadow-lg md:w-4/5 md:left-[10%] md:top-1/4 md:h'>
            ...
            <div className='mt-5'>
                ...
                <div className='relative'>
                    ...
                    : <input id="pickUp" name="pickUp" value={rentalData.pickUp} onChange={handleChange} type="text" placeholder="Airport, city or address" className={`w-full border-b-2 border-orange-500 px-10 h-10 md:text-2xl placeholder:font-bold placeholder:text-gray-600 md:placeholder:text-2xl hover:border-orange-300 focus:bg-white`} /> }
            ...
            <div className='mt-2 '>
                ...
                <button className='group inline-block ml-1 text-slate-500 font-semibold font-roboto text-sm p-1'>
                    ...
                    <details open className='text-left border border-orange-400 px-2 hidden group-focus-within:block accent-white'>
                        <summary></summary>
                        <input name="return" value={rentalData.return} onChange={handleChange} type="text" className='border focus:border-white h-5 outline-none' />
                    </details>
                </button>
            </div>
            <div className='flex justify-between gap-3 mt-7'>
                <div className=' flex flex-col gap-2'>
                    ...
                    : <input id="pickUpDate" name="pickUpDate" value={rentalData.pickUpDate} onChange={handleChange} type="date" className={`p-1 border-b border-slate-700 font-semibold w-36 placeholder:text-[.9rem] md:text-2xl`} placeholder='Select pick-up date' /> }
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    :  <input id="returnDate" name="returnDate" value={rentalData.returnDate} onChange={handleChange} type="date" className={`p-1 border-b border-slate-700 font-semibold w-36 placeholder:text-[.9rem]  md:text-2xl`} placeholder='Select return date' /> }
                </div>
            </div>
