...
export default function Header({ isSignIn, setIsSignIn, cartItems, cartCount, setCartCount }) {
    ...
    return (
        <>
            <header className="relative top-0 w-auto p-2 bg-gray-900 m-1 flex align-middle mb-3 md:fixed md:w-full md:h-[7.5rem] md:z-10 xl:left-0 ">
                    ...
                    {logIn ?
                        ...
                        (<>
                            <ul onClick={() => handleMenuClick("close")} className=' lg:hidden md:justify-around md:mt-20 md:w-full' >
                                ...
                                <li><NavLink to="/sign-in " className='text-purple text-white pt-3 text-xl mt-3 md:py-6 bg-green-500 hover:bg-green-700 active:bg-green-600 font-bold block rounded-xl p-2 text-center md:text-[2rem]'>Sign In</NavLink></li>
